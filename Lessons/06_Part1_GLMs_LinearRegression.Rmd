...
Show how the residuals follow the normal distribution.
...
Show the potential of outliers.

```{r, fig.height = 3, fig.width = 4}
par(mfrow = c(2,2), mar=c(4,4,4,4)) # 1st argument make it 2 rows and 2 columns
# 2nd argument decide the size of each window.
plot(irradiance.regression)
par(mfrow = c(1,1)) # if there's no 1st line, this can let 4 plots show one by one
```
