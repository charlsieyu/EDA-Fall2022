...
NTL.nutrient.data.PeterPaul.gathered <- subset(NTL.nutrient.data.PeterPaul.gathered, !is.na(concentration))  # remove rows with concentration equaling zero
...
# the data frame here has 2404 observations that is two less than the original one, because we remove NAs and there are two raws with all 5 nutrients being NA
